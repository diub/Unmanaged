...
static public partial class Comparing {
	...
	/// <returns></returns>
	unsafe static public int CompareUnsafe (byte* Left, byte* Right, Int32 Length) {
		int i, rest;
		UInt32* l, r;
		byte* bl, br;
	...
	/// <returns></returns>
	unsafe static public int CompareUnmanaged<T> (this T [] Left, Int32 LeftStart, T [] Right, Int32 RightStart, Int32 Length) where T : unmanaged {
		byte* l, r;
		int size;
